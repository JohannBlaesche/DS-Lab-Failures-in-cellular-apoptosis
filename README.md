...
```
cd existing_repo
git remote add origin https://gitlab.kit.edu/kit/ipd-boehm/teaching/ds-lab/ds-lab-2024-students/mandalorians/task-1-earthquake-damage-prediction.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.kit.edu/kit/ipd-boehm/teaching/ds-lab/ds-lab-2024-students/mandalorians/task-1-earthquake-damage-prediction/-/settings/integrations)
